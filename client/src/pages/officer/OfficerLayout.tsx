        ...
        return (
            <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-slate-900/80 border border-rose-500/30 rounded-2xl p-6 text-center shadow-xl">
                    ...
                    <h2 className="text-xl font-bold text-slate-100 mb-2">Officer Access Only</h2>
                    <p className="text-sm text-slate-400 mb-6">
                        You must be signed in as an authorized Insurance Adjudication Officer to access this section.
                    </p>
                    <button
